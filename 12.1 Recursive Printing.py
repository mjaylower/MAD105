...
def main():
    ...
    printing(n)  # call the printing function


# define the printing function
def printing(n):  # pass the value from the user input int
    if n > 0:  # while the value is greater than zero execute the statements
        printing(n-1)  # set the recursive function to count down till 0 which will stop the loop
